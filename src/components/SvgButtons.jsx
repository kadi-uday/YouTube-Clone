  ...
  return (
    <div>
          <div className="flex flex-wrap gap-6 md:gap-4 md:mb-2 md:-mr-[10px] lg:-mr-0 lg:gap-8 lg:mt-3">
            <button className="flex w-16 px-5 items-center gap-1 py-1.5 lg:h-16 lg:w-28 lg:pl-9 bg-[#272727] hover:bg-white/10 rounded-md lg:rounded-xl">
            ...
            <button className="flex items-center gap-1 w-16 px-5 py-1.5 lg:h-16 lg:w-28 lg:pl-9 bg-[#272727] hover:bg-white/10 rounded-md lg:rounded-xl">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 lg:w-9 lg:h-9 text-white " viewBox="0 0 24 24" fill="white">
            ...
            <button className="flex items-center gap-1 px-3 py-1.5 bg-[#272727] hover:bg-white/10 lg:text-xl rounded-md lg:rounded-xl">
            ...
            <button className="flex items-center gap-1 px-[17px] py-1.5 bg-[#272727] hover:bg-white/10 lg:text-xl rounded-md lg:rounded-xl">
